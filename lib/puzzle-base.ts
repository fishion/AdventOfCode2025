...
export default class PuzzleBase {
  ...
  answer() {
    const pt1Result = this.ans.pt1 == this.testAns.pt1 ? ', Correct' : `, expected '${this.testAns.pt1}'`
    const pt2Result = this.ans.pt2 == this.testAns.pt2 ? ', Correct' : `, expected '${this.testAns.pt2}'`
